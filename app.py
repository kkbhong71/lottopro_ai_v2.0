...
class AdvancedLottoPredictor:
    def __init__(self, csv_file_path='new_1194.csv'):
    ...
    def load_data(self):
        ...
        try:
            ...
            possible_paths = [
                'new_1194.csv',
                './new_1194.csv',
                os.path.join(current_dir, 'new_1194.csv'),
                'data/new_1194.csv'
            ]
            ...
            if found_file:
                ...
                print(f"❌ new_1194.csv 파일을 찾을 수 없습니다")
                # 파일 목록 확인
                try:
        ...
        if pred.data is not None and pred.numbers is not None and pred.data_loaded:
            try:
                ...
                stats = {
                    ...
                    'last_draw_info': {
                        'round': safe_int(last_row.get('round', 1194)),
