...
def load_csv_data_ultra_safe():
    ...
    try:
        # 여러 파일명 시도
        possible_files = ['new_1185.csv', 'static/data/new_1185.csv', 'data/new_1185.csv']
...
def generate_ultra_safe_sample_data():
    ...
    try:
        ...
        # 실제와 유사한 고품질 데이터 생성
        for draw in range(1185, 985, -1):  # 200회차
            try:
                ...
                # 날짜 계산
                base_date = datetime(2024, 8, 19) - timedelta(weeks=(1185-draw))
        ...
        return [
            {'회차': 1185, '당첨번호1': 2, '당첨번호2': 6, '당첨번호3': 12, '당첨번호4': 31, '당첨번호5': 33, '당첨번호6': 40, '보너스번호': 15, '날짜': '2024-08-19'},
            {'회차': 1184, '당첨번호1': 14, '당첨번호2': 16, '당첨번호3': 23, '당첨번호4': 25, '당첨번호5': 31, '당첨번호6': 37, '보너스번호': 42, '날짜': '2024-08-12'},
            {'회차': 1183, '당첨번호1': 4, '당첨번호2': 15, '당첨번호3': 17, '당첨번호4': 23, '당첨번호5': 27, '당첨번호6': 36, '보너스번호': 31, '날짜': '2024-08-05'}
        ]
...
def initialize_data_ultra_safe():
    ...
    try:
        ...
        # 최후의 수단
        sample_data = [
            {'회차': 1185, '당첨번호1': 2, '당첨번호2': 6, '당첨번호3': 12, '당첨번호4': 31, '당첨번호5': 33, '당첨번호6': 40, '보너스번호': 15}
        ]
        return sample_data
...
def calculate_tax():
    ...
    try:
        ...
        if prize_amount <= 50000:  # 5만원 이하
            tax = 0
            net_amount = prize_amount
        else:
            # 소득세 22% + 지방소득세 2.2% = 24.2%
            tax_rate = 0.242
            tax = (prize_amount - 50000) * tax_rate
        ...
        return jsonify({
            ...
            'tax_rate': 24.2 if prize_amount > 50000 else 0,
